...
public class AppSettings {
	...
	public static String DAY_CANDLE_ENDPOINT = "https://min-api.cryptocompare.com/data/v2/histoday?fsym=%s&tsym=%s&limit="+CANDLE_PERIOD+"&api_key="+CRYPTO_API_KEY;
	public static String HOUR_CANDLE_ENDPOINT = "https://min-api.cryptocompare.com/data/v2/histohour?fsym=%s&tsym=%s&limit="+CANDLE_PERIOD+"&api_key="+CRYPTO_API_KEY;
